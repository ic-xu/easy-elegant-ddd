 ...
 **/
public class E505HTTPVersonNotSupportedException extends BaseServerException{



    public E505HTTPVersonNotSupportedException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
