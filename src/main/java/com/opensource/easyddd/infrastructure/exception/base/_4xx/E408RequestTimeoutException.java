 ...
 **/
public class E408RequestTimeoutException extends BaseClientException {

    public E408RequestTimeoutException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
