 ...
 **/
public class E406NotAcceptableException extends BaseClientException {

    public E406NotAcceptableException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
