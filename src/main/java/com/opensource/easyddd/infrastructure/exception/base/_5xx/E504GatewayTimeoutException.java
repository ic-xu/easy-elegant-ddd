 ...
 **/
public class E504GatewayTimeoutException extends BaseServerException{



    public E504GatewayTimeoutException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
