 ...
 **/
public class E403ForbiddenException extends BaseClientException {

    public E403ForbiddenException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
