 ...
 **/
public class E506InsufficientStorageException extends BaseServerException{



    public E506InsufficientStorageException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
