 ...
 **/
public class E405MethodNotAllowedException extends BaseClientException {

    public E405MethodNotAllowedException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
