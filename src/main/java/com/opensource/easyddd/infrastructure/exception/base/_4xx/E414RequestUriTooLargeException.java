 ...
 **/
public class E414RequestUriTooLargeException extends BaseClientException {

    public E414RequestUriTooLargeException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
