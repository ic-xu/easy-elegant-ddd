 ...
 **/
public class E411PreconditionFailedException extends BaseClientException {

    public E411PreconditionFailedException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
