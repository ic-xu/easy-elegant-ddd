 ...
 **/
public class E451UnavailableForLegalReasonsException extends BaseClientException {

    public E451UnavailableForLegalReasonsException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
