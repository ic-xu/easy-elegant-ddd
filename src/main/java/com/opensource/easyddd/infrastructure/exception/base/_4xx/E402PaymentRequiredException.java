 ...
 **/
public class E402PaymentRequiredException extends BaseClientException {

    public E402PaymentRequiredException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
