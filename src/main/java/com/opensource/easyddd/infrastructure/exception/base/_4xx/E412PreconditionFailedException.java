 ...
 **/
public class E412PreconditionFailedException extends BaseClientException {

    public E412PreconditionFailedException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
