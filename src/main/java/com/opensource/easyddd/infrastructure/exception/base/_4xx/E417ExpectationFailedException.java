 ...
 **/
public class E417ExpectationFailedException extends BaseClientException {

    public E417ExpectationFailedException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
