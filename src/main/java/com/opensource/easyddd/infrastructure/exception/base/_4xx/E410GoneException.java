 ...
 **/
public class E410GoneException extends BaseClientException {

    public E410GoneException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
