 ...
 **/
public class E409ConflictException extends BaseClientException {

    public E409ConflictException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
