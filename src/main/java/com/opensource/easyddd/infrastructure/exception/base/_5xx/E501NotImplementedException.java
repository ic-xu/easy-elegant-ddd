 ...
 **/
public class E501NotImplementedException extends BaseServerException{



    public E501NotImplementedException(ModuleCode serverMode, int customerErrorCode, String message) throws ExceptionCodeError {
